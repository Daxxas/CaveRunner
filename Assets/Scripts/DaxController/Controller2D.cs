...
{
    //Don't forget to set  Project Settings > Physics > Auto Sync Transforms to true
    //                     Project Settings > Physics2D > Auto Sync Transforms to true
        ...
        for (int i = 0; i < verticalRayCount; i++)
        {
            ...
            if (hit)
            {
                if (hit.collider.tag == "Through")
                {
                    ...
                    if (Mathf.RoundToInt(playerInput.y) == -1)
                    {
    ...
    void ClimbSlope(ref Vector2 moveAmount, float slopeAngle, Vector2 slopeNormal)
    {
        ...
        {
            print("if (moveAmount.y < climbmoveAmountY) = " + moveAmount.y + " < " + climbmoveAmountY);
